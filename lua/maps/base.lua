...
function M.base_movement()
  ...
  map('i', '<C-j>', '<Down>', { desc = 'Move Cursor Down', noremap = true })
  map('i', '<C-h>', '<Left>', { desc = 'Move Cursor Left', noremap = true })
  map('i', '<C-l>', '<Right>', { desc = 'Move Cursor Right', noremap = true })
end
...
function M.control()
  ...
  map('n', '<leader>ca', '<Cmd>%y+<CR>', {
    desc = 'Copy Current Buffer Into System Clipboard',
    silent = true,
  })
  ...
  map('n', '<leader><CR>', '<Cmd>noh<CR>', {
    desc = 'Hide Highlight Temporarily',
    silent = true,
  })
  map('n', '<leader>wl', '<Cmd>set wrap!<CR>', {
    desc = 'Toogle Line Wrap',
    silent = true,
  })
